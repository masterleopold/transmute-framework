...
<!-- TODO: Stage 3 — replace with actual async assertion pattern for [BACKEND_FRAMEWORK] -->
...
- Per CLAUDE.md Part 1 Component Tests, test all five states, include axe-core checks (`[AXE_INTEGRATION]`), and mock backend hooks (`[HOOK_MOCK_PATTERN]`) — not the API layer directly.
